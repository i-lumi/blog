...
module.exports = {
    ...
    title: 'i-lumi 博客',
    description:
        'web前端技术博客,简洁至上,专注web前端学习与总结。JavaScript,js,ES6,TypeScript,vue,go,css3,html5,Node,git,github等技术文章。', // 描述,以 <meta> 标签渲染到页面html中
    ...
    themeConfig: {
        ...
        repo: 'i-lumi/blog', // 导航栏右侧生成Github链接
        ...
        author: {
            ...
            name: 'i-lumi', // 必需
            link: 'https://github.com/i-lumi' // 可选的
        },
        blogger: {
            // 博主信息，显示在首页侧边栏
            avatar:
        ...
        footer: {
            ...
            copyrightInfo:
                'i-lumi | <a href="https://github.com/i-lumi/blog/blob/master/LICENSE" target="_blank">MIT License</a>' // 博客版权信息，支持a标签
        }
    },
    plugins: [
        // 插件
        ...
        [
            ...
            // },
            {
                ...
                options: {
                    ...
                    clientSecret: '',
                    repo: 'blog', // GitHub 仓库
                    owner: 'i-lumi', // GitHub仓库所有者
                    admin: ['i-lumi'], // 对仓库有写权限的人
